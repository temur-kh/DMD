...
cursor.execute("CREATE TABLE IF NOT EXISTS `Car_Model`("
               "`model` VARCHAR(30) NOT NULL, "
...
cursor.execute("CREATE TABLE IF NOT EXISTS `Customer`("
               ...
               "PRIMARY KEY (`id`),"
               "FOREIGN KEY (`nearest_station`) REFERENCES `Charging_Station`(`id`))")
...
cursor.execute("CREATE TABLE IF NOT EXISTS `Charging_Station_Plugs`("  #+++++++++
...
cursor.execute("CREATE TABLE IF NOT EXISTS `Workshop_Car_Parts`("  #+++++++++++
